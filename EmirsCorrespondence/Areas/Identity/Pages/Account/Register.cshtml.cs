...
namespace EmirsCorrespondence.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IUserEmailStore<Users> emailStore,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Users { UserName = Input.Email, Email = Input.Email }; // Fixed to Users class
        ...
        private IUserEmailStore<Users> GetEmailStore()
        {
            ...
            return (IUserEmailStore<Users>)_userManager;
        }
    }
}
